...
@onready var modes: Node2D = $Modes
@onready var death_particles: GPUParticles2D = %DeathParticles

@onready var square_mode: SquareMode = $Modes/SquareMode
@onready var wave_mode: WaveMode = $Modes/WaveMode
@onready var ufo_mode: ModeBase = $Modes/UfoMode
@onready var ball_mode: BallMode = $Modes/BallMode
@onready var robot_mode: RobotMode = $Modes/RobotMode
@onready var spaceship_mode: SpaceshipMode = $Modes/SpaceshipMode
...
func _reset_modes_visibility() -> void:
	for item: Node in modes.get_children():
		if item is ModeBase:
